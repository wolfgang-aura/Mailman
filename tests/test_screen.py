...
class ScreenTests(unittest.TestCase):
    ...
    def test_cirqs_cla_clause_on_generated_code_fails_the_gate(self) -> None:
        ...
        # candidate had to be dropped after the guide was read by hand.
        with tempfile.TemporaryDirectory() as temporary:
            record = _screen(
                Path(temporary),
                FakeGitHub(
                    policies={
                        "CONTRIBUTING.md": (
                            ...
                            "> Any code that you contribute to this project "
                            "must be **your** original creation. Code "
                            "generated by artificial intelligence tools "
                            "**does not** qualify as your original creation.\n"
                        )
                    }
                ),
            )
