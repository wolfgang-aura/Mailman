...
def render_retrospective(retrospective: Retrospective) -> str:
    ...
    lines.extend(
        [
            ...
            "PROMOTED_TO_SKILL`. Validation needs evidence from at least two",
            "distinct runs and at least one observation a machine or a human",
            "made. An agent's own account of its work cannot validate a rule",
            "about that agent.",
            "",
        ]
    )
